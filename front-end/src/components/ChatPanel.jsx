  ...
  return (
    <div className='flex flex-col h-full bg-white'>
         ...
         <div className='flex-1 overflow-y-auto p-3 space-y-3 hide-scrollbar'>
           {messages.length === 0 && (
            <div className='flex items-center justify-centernh-full'>
            ...
            {messages.map((msg, i)=> (
              <div key={i}>
                <div className='flexgap-2.5 items-start'>
                   <div className='shrink-0 w-6 h-6 rounded-md flex items-center justify-center mt-o.5 bg-zinc-50'>
                    {msg.role === "user" ? (
                   ...
                   <div className='flex-1 min-w-0'>
                     ...
                     <p className='text-[13px] text-zinc-700 loading- tracking-wider whitespace-pre-wrap wrap-break-word'>
