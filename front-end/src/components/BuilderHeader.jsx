  ...
  return (
    <header className='h-12 shrink-0 flex items-center justify-between px-3 border-b border-zinc-200 bg-white'>
      <div className='flex items-center gap-2'>
        ...
        <img src="/logo (1).svg" alt="" className='invert size-5' />
     ...
     <div className='flex items-center gap-1.5'>
       ...
       className={`inline-flex items-center justify-center gap-1.5 py-1.5 border border-zinc-200 text-zinc-600 hover:bg-zinc-100 hover:text-zinc-900 text-xs font-medium rounded-lg cursor-pointer bg-white ${showCode ? "bg-zinc-100 text-zinc-900" : ""}`}>
          {showCode ? (
            <>
