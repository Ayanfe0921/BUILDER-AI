...
import { CloudUploadIcon, Loader2Icon, MicIcon, ArrowRightIcon } from 'lucide-react'
...
const PromptInput = ({
  ...
  return (
    <div className={`bg-white border border-zinc-200 rounded-xl flex items-end gap-2 focus-within:ring-zinc-300 transition ${large ? "p-4" : "p-3"}`}>
